...
option_dict = {
    # Economy
    "National GDP (Current Prices in € Billions)": {
        "df_func": get_gdp,
        "category": "Economy",
        "plot_type": "line",
        "columns": "values",
    ...
    "Regional GDP (Current Prices in € Billions)": {
    ...
    "National GDP per Capita (€ per Inhabitant)": {
    ...
    "Regional GDP per Capita (€ per Inhabitant)": {
    ...
    "Energy Consumption (Kgs of Oil Equivalent per Capita)": {
